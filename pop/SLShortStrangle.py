...
def calculate_pop(percentage, closing_days, underlying, sigma, rate, trials, days_to_expiration, call_short_strike, call_short_price, put_short_strike, put_short_price):
    ...
    pop_value = float(poptions.shortStrangle(
        ...
        [closing_days], [percentage], call_short_strike,
    ...
    try:
        ...
        if st.button("Calculate"):
            ...
            with st.spinner("Calculating..."):
                ...
                pop_values = pool.starmap(calculate_pop, [(p, cd, underlying, sigma, rate, trials, days_to_expiration, call_short_strike, call_short_price, put_short_strike, put_short_price) for p, cd in results])
                pool.close()
                pool.join()
            ...
            max_risk = ((call_short_strike - put_short_strike) + (put_short_price - call_short_price))*100
