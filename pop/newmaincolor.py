...
def main():
    try:
        ...
        underlying = st.number_input("Enter the underlying price:", placeholder="e.g. 347.47", min_value=None)
        sigma = st.number_input("Enter the sigma (volatility) as a percentage:", placeholder="e.g. 11.27", min_value=None)
        rate = st.number_input("Enter the interest rate as a percentage:", placeholder="e.g. 5.28", min_value=None)
        days_to_expiration = st.number_input("Enter the days to expiration:", placeholder="e.g. 9", min_value=None)
        ...
        short_strike = st.number_input("Enter the short strike:", placeholder="e.g. 350", min_value=None)
        short_price = st.number_input("Enter the short price:", placeholder="e.g. 2.46", min_value=None)
        long_strike = st.number_input("Enter the long strike:", placeholder="e.g. 347.50", min_value=None)
        long_price = st.number_input("Enter the long price:", placeholder="e.g. 1.01", min_value=None)
